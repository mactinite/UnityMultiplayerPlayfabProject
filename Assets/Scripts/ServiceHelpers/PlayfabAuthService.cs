...
using Facebook.Unity;
    ...
    public class PlayFabAuthService
    {
        ...
        /// <summary>
        /// Authenticate a user in PlayFab using an Username & Password combo
        /// </summary>
        private void AuthenticateUsernamePassword()
        {
            ...
            }, LoginSuccess, (error) =>
            {
                if (error.Error == PlayFabErrorCode.AccountNotFound)
                {
                    ...
                    (RegisterPlayFabUserResult success) =>
                    {
                        //store identity and session
                        _playFabId = success.PlayFabId;
                        _sessionTicket = success.SessionTicket;
                        ...
                        if (OnLoginSuccess != null)
                        {
                            ...
                            OnLoginSuccess.Invoke(new LoginResult
                            {
                                ...
                                EntityToken = success.EntityToken,
                            });
                        }
                    },
                    (error) =>
